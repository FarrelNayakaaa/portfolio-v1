  ...
  return (
    <section id="projects" className="py-20 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Menggunakan flex-wrap dan justify-center agar item ganjil otomatis di tengah */}
            ...
            >
              ...
              <div className="p-8">
                ...
                <div className="flex items-center gap-4">
                    {/* Kondisi jika link tersedia atau masih dalam pengembangan */}
                    {project.link ? (
                      <a 
                        href={project.link} 
                        target="_blank" 
                      ...
                      <span className="flex items-center gap-2 text-sm font-semibold text-gray-500 cursor-not-allowed bg-white/5 px-3 py-1.5 rounded-xl border border-white/5">
